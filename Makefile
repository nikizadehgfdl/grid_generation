...
ocean_hgrid_res0.5_MIDAS.nc:
	...
	./ocean_grid_generator.py -f ocean_hgrid_res0.5_MIDAS.nc -r 2 --rdp 0 --south_cutoff_row 81 --reproduce_MIDAS_grids --no_changing_meta --write_subgrid_files
ocean_hgrid_res0.25_MIDAS.nc:
	#module swap python/2.7.3_workstation On gfdl pan
	./ocean_grid_generator.py -f ocean_hgrid_res0.25_MIDAS.nc -r 4 --south_cutoff_row 81 --reproduce_MIDAS_grids --no_changing_meta --write_subgrid_files
ocean_hgrid_res0.25.nc:
	./ocean_grid_generator.py -f ocean_hgrid_res0.25.nc -r 4 --south_cutoff_row 81 --no_changing_meta --write_subgrid_files
ocean_hgrid_res0.125.nc:
	./ocean_grid_generator.py -f ocean_hgrid_res0.125.nc -r 8 --write_subgrid_files --no_changing_meta --write_subgrid_files
ocean_hgrid_res0.125_old.nc:
	#module swap python/3.6.4 On gfdl pan
	./ocean_grid_generator.py -f ocean_hgrid_res0.125_old.nc -r 8 --reproduce_old8_grids --no_changing_meta --write_subgrid_files
